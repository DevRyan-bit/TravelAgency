...
const AboutPage = () => {
    return (<div>
      ...
      <section className="relative h-[50vh] bg-cover bg-center" style={{ backgroundImage: "url('/images/book-2341083_1280.jpg')" }}>
      ...
      <motion.section className="py-20 bg-brand-dark" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <img src="/images/konigssee-7276585_1280.jpg" alt="Crafting a journey" className="rounded-lg shadow-2xl"/>
          </div>
        </div>
      </motion.section>
          ...
          <div className="container mx-auto px-6 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-8">
                <div className="text-center">
                    <img src="/images/horse-profile-2679776_1280.jpg" alt="Team Member 1" className="w-40 h-40 rounded-full mx-auto mb-4 border-4 border-brand-gold/50 object-cover"/>
                    <h4 className="text-xl font-bold text-white">Person 1</h4>
                    <p className="text-brand-gold">Founder & CEO</p>
                </div>
                <div className="text-center">
                    <img src="/images/horse-profile-2679776_1280.jpg" alt="Team Member 2" className="w-40 h-40 rounded-full mx-auto mb-4 border-4 border-brand-gold/50 object-cover"/>
                    <h4 className="text-xl font-bold text-white">Person 2</h4>
                    <p className="text-brand-gold">Head of Travel Design</p>
                </div>
                <div className="text-center">
                    <img src="/images/horse-profile-2679776_1280.jpg" alt="Team Member 3" className="w-40 h-40 rounded-full mx-auto mb-4 border-4 border-brand-gold/50 object-cover"/>
